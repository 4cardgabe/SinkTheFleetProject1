...
int main(void)
{
	...
	do
	{
		...
		for(whichPlayer = 0; whichPlayer < NUMPLAYERS; whichPlayer++)
		{
			...
			if (whichPlayer == 0)
			{
				char c = safeChoice("Player 1, Would you like to read the starting grid from a file? ");
				if (c == 'Y')
				{
					string filename;
			...
			{
				char c = safeChoice("Player 2, Would you like to read the starting grid from a file? ");
				if (c == 'Y')
				{
					string filename;
					cout << "Enter file name: ";
